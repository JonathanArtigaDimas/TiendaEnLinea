...
const ProductDetails = () => {
  ...
  //obtener un solo producto basado en la id
  ...
  return <section className='pt-32 pb-12 lg:py-32
  h-screen flex items-center'>
    <div className='container mx-auto'>
      {/* imagen y texto wrapp */}
      ...
      items-center'>
        ...
        lg:text-left'>
          ...
          mb-6'>
            ...
            <button 
            onClick={() => addToCart(product, product.id)} className='bg-black py-4 px-8
