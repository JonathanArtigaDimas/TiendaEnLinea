...
//importar el sidebarContext y cartContext
...
const Sidebar = () => {
  ...
  duration-300 z-20 px-4 lg:px-[35px]`}>
    ...
    h-[300px] lg:h-[325px] overflow-y-auto
    ...
    mt-4'>
      ...
      items-center text-black w-full font-medium'> View Cart </Link>
      <Link to={'/'} className='bg-gray-900 flex p-4 justify-center
